...
首次使用需要配置 Whisper 服务器：
1. 点击右上角 ⚙ 按钮打开设置
2. 在服务器列表中添加 Whisper API 服务器
3. 可选：为服务器命名（如 "GPU 服务器"、"本地服务器"）
4. 可添加多个服务器，选择其中一个设为默认
5. 点击保存
...
- `total_entries`: 总转录次数
- `entries`: 转录摘要列表（只包含 ID、时间戳和文本预览）
